...
def load_params_from_file(file, args):
    config_addr = './softgroup/model/ulip/pointbert/PointTransformer_8192point.yaml'
    config = cfg_from_yaml_file(config_addr)
    model = PointTransformer(config.model, args=args)
