...
from .pointbert.point_encoder import PointTransformer, cfg_from_yaml_file
...
#     elif args.loss_type == 'two_branch':
#         return losses.ULIPWithImageTwoBranchLoss()
...
# def ULIP_PN_MLP_TWO_BRANCH(args):
#     vision_model = timm.create_model('vit_base_patch16_224', num_classes=0)
#
#     # =====================================================================
#     # import the 3D backbone and specify the output point cloud feature dimension
...
#     # =====================================================================
#
#     model = ULIP_WITH_IMAGE_TWO_BRANCH(embed_dim=512, vision_width=768, point_encoder=point_encoder, vision_model=vision_model,
#                             context_length=77, vocab_size=49408,
#                             transformer_width=512, transformer_heads=8, transformer_layers=12, pc_feat_dims=pc_feat_dims)
#
#     if not args.evaluate_3d:
...
def make(config):
    ...
    # config_addr = './pointbert/PointTransformer_8192point.yaml'
    # pre_path = "/home/zzh/project/open_world_shape/pretrained_models_ckpt_zero-sho_classification_pointbert_ULIP-2.pt"
    # config = cfg_from_yaml_file(config_addr)
    point_encoder = PointTransformer(config.model, args=None)
    ckpt = torch.load(
    ...
    point_encoder.load_state_dict(state_dict, strict=True)
    # print("here")
    # pc_feat_dims = 768
